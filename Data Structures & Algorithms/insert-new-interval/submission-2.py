class Solution:
    def insert(self, intervals: List[List[int]], newInterval: List[int]) -> List[List[int]]:
        ...
        # NOTE: WIll take some visualization when coming back to it
        ...
        this combination of logic basically ensures that we are only qualifying intervals that are either
        overlapping, new is inside of the current interval or the current interval is inside of new
        '''
